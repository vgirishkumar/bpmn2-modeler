 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.PoissonDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PoissonDistributionTypeImpl extends DistributionParameterImpl implements PoissonDistributionType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.POISSON_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.POISSON_DISTRIBUTION_TYPE__MEAN:
				return getMean();
		}
