 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.CostParametersImpl#getFixedCost <em>Fixed Cost</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.CostParametersImpl#getUnitCost <em>Unit Cost</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.CostParametersImpl#getCurrencyUnit <em>Currency Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CostParametersImpl extends EObjectImpl implements CostParameters {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.COST_PARAMETERS;
	}
	...
	public NotificationChain basicSetFixedCost(Parameter newFixedCost, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.COST_PARAMETERS__FIXED_COST, oldFixedCost, newFixedCost);
	...
	public void setFixedCost(Parameter newFixedCost) {
		if (newFixedCost != fixedCost) {
			...
			if (fixedCost != null)
				msgs = ((InternalEObject)fixedCost).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COST_PARAMETERS__FIXED_COST, null, msgs);
			if (newFixedCost != null)
				msgs = ((InternalEObject)newFixedCost).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COST_PARAMETERS__FIXED_COST, null, msgs);
			msgs = basicSetFixedCost(newFixedCost, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COST_PARAMETERS__FIXED_COST, newFixedCost, newFixedCost));
	}
	...
	public NotificationChain basicSetUnitCost(Parameter newUnitCost, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.COST_PARAMETERS__UNIT_COST, oldUnitCost, newUnitCost);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUnitCost(Parameter newUnitCost) {
		if (newUnitCost != unitCost) {
			NotificationChain msgs = null;
			if (unitCost != null)
				msgs = ((InternalEObject)unitCost).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COST_PARAMETERS__UNIT_COST, null, msgs);
			if (newUnitCost != null)
				msgs = ((InternalEObject)newUnitCost).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COST_PARAMETERS__UNIT_COST, null, msgs);
			msgs = basicSetUnitCost(newUnitCost, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COST_PARAMETERS__UNIT_COST, newUnitCost, newUnitCost));
	}
	...
	public void setCurrencyUnit(String newCurrencyUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COST_PARAMETERS__CURRENCY_UNIT, oldCurrencyUnit, currencyUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.COST_PARAMETERS__FIXED_COST:
				return basicSetFixedCost(null, msgs);
			case ModelPackage.COST_PARAMETERS__UNIT_COST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.COST_PARAMETERS__UNIT_COST:
				return getUnitCost();
			case ModelPackage.COST_PARAMETERS__CURRENCY_UNIT:
