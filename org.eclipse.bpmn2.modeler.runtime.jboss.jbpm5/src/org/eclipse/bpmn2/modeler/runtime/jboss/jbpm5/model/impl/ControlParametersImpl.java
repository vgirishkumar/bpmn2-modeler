 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ControlParametersImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ControlParametersImpl#getInterTriggerTimer <em>Inter Trigger Timer</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ControlParametersImpl#getMaxTriggerCount <em>Max Trigger Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ControlParametersImpl extends EObjectImpl implements ControlParameters {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CONTROL_PARAMETERS;
	}
	...
	public NotificationChain basicSetProbability(Parameter newProbability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__PROBABILITY, oldProbability, newProbability);
	...
	public void setProbability(Parameter newProbability) {
		if (newProbability != probability) {
			...
			if (probability != null)
				msgs = ((InternalEObject)probability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__PROBABILITY, null, msgs);
			if (newProbability != null)
				msgs = ((InternalEObject)newProbability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__PROBABILITY, null, msgs);
			msgs = basicSetProbability(newProbability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__PROBABILITY, newProbability, newProbability));
	}
	...
	public NotificationChain basicSetInterTriggerTimer(Parameter newInterTriggerTimer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, oldInterTriggerTimer, newInterTriggerTimer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInterTriggerTimer(Parameter newInterTriggerTimer) {
		if (newInterTriggerTimer != interTriggerTimer) {
			...
			if (interTriggerTimer != null)
				msgs = ((InternalEObject)interTriggerTimer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, null, msgs);
			if (newInterTriggerTimer != null)
				msgs = ((InternalEObject)newInterTriggerTimer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, null, msgs);
			msgs = basicSetInterTriggerTimer(newInterTriggerTimer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, newInterTriggerTimer, newInterTriggerTimer));
	}
	...
	public NotificationChain basicSetMaxTriggerCount(Parameter newMaxTriggerCount, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__MAX_TRIGGER_COUNT, oldMaxTriggerCount, newMaxTriggerCount);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaxTriggerCount(Parameter newMaxTriggerCount) {
		if (newMaxTriggerCount != maxTriggerCount) {
			...
			if (maxTriggerCount != null)
				msgs = ((InternalEObject)maxTriggerCount).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__MAX_TRIGGER_COUNT, null, msgs);
			if (newMaxTriggerCount != null)
				msgs = ((InternalEObject)newMaxTriggerCount).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.CONTROL_PARAMETERS__MAX_TRIGGER_COUNT, null, msgs);
			msgs = basicSetMaxTriggerCount(newMaxTriggerCount, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONTROL_PARAMETERS__MAX_TRIGGER_COUNT, newMaxTriggerCount, newMaxTriggerCount));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.CONTROL_PARAMETERS__PROBABILITY:
				return basicSetProbability(null, msgs);
			case ModelPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER:
				return basicSetInterTriggerTimer(null, msgs);
			case ModelPackage.CONTROL_PARAMETERS__MAX_TRIGGER_COUNT:
