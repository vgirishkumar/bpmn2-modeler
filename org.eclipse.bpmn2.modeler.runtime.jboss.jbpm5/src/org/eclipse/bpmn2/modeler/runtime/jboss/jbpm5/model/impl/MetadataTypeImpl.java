 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.MetadataTypeImpl#getMetaentry <em>Metaentry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetadataTypeImpl extends EObjectImpl implements MetadataType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.METADATA_TYPE;
	}
	...
	public EList<MetaentryType> getMetaentry() {
		if (metaentry == null) {
			metaentry = new EObjectContainmentEList<MetaentryType>(MetaentryType.class, this, ModelPackage.METADATA_TYPE__METAENTRY);
		}
		return metaentry;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.METADATA_TYPE__METAENTRY:
