 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.EnumParameterTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.EnumParameterTypeImpl#getParameterValueGroup <em>Parameter Value Group</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.EnumParameterTypeImpl#getParameterValue <em>Parameter Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumParameterTypeImpl extends ParameterValueImpl implements EnumParameterType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ENUM_PARAMETER_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, ModelPackage.ENUM_PARAMETER_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getParameterValueGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(ModelPackage.Literals.ENUM_PARAMETER_TYPE__PARAMETER_VALUE_GROUP);
	}
	...
	public EList<ParameterValue> getParameterValue() {
		return getParameterValueGroup().list(ModelPackage.Literals.ENUM_PARAMETER_TYPE__PARAMETER_VALUE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ENUM_PARAMETER_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case ModelPackage.ENUM_PARAMETER_TYPE__PARAMETER_VALUE_GROUP:
				return ((InternalEList<?>)getParameterValueGroup()).basicRemove(otherEnd, msgs);
			case ModelPackage.ENUM_PARAMETER_TYPE__PARAMETER_VALUE:
