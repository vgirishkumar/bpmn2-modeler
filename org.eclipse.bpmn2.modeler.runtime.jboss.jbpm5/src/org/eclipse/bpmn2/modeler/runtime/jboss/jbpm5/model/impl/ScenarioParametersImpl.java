 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getStart <em>Start</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getPropertyParameters <em>Property Parameters</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getBaseCurrencyUnit <em>Base Currency Unit</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getBaseTimeUnit <em>Base Time Unit</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getReplication <em>Replication</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ScenarioParametersImpl#getSeed <em>Seed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScenarioParametersImpl extends EObjectImpl implements ScenarioParameters {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SCENARIO_PARAMETERS;
	}
	...
	public NotificationChain basicSetStart(Parameter newStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__START, oldStart, newStart);
	...
	public void setStart(Parameter newStart) {
		if (newStart != start) {
			...
			if (start != null)
				msgs = ((InternalEObject)start).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__START, null, msgs);
			if (newStart != null)
				msgs = ((InternalEObject)newStart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__START, null, msgs);
			msgs = basicSetStart(newStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__START, newStart, newStart));
	}
	...
	public NotificationChain basicSetDuration(Parameter newDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__DURATION, oldDuration, newDuration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDuration(Parameter newDuration) {
		if (newDuration != duration) {
			NotificationChain msgs = null;
			if (duration != null)
				msgs = ((InternalEObject)duration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__DURATION, null, msgs);
			if (newDuration != null)
				msgs = ((InternalEObject)newDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__DURATION, null, msgs);
			msgs = basicSetDuration(newDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__DURATION, newDuration, newDuration));
	}
	...
	public NotificationChain basicSetPropertyParameters(PropertyParameters newPropertyParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, oldPropertyParameters, newPropertyParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPropertyParameters(PropertyParameters newPropertyParameters) {
		if (newPropertyParameters != propertyParameters) {
			...
			if (propertyParameters != null)
				msgs = ((InternalEObject)propertyParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, null, msgs);
			if (newPropertyParameters != null)
				msgs = ((InternalEObject)newPropertyParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, null, msgs);
			msgs = basicSetPropertyParameters(newPropertyParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, newPropertyParameters, newPropertyParameters));
	}
	...
	public void setBaseCurrencyUnit(String newBaseCurrencyUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__BASE_CURRENCY_UNIT, oldBaseCurrencyUnit, baseCurrencyUnit));
	}
	...
	public void setBaseTimeUnit(TimeUnit newBaseTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT, oldBaseTimeUnit, baseTimeUnit, !oldBaseTimeUnitESet));
	}
	...
	public void unsetBaseTimeUnit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT, oldBaseTimeUnit, BASE_TIME_UNIT_EDEFAULT, oldBaseTimeUnitESet));
	}
	...
	public void setReplication(int newReplication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__REPLICATION, oldReplication, replication, !oldReplicationESet));
	}
	...
	public void unsetReplication() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.SCENARIO_PARAMETERS__REPLICATION, oldReplication, REPLICATION_EDEFAULT, oldReplicationESet));
	}
	...
	public void setSeed(long newSeed) {
		...
		seedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCENARIO_PARAMETERS__SEED, oldSeed, seed, !oldSeedESet));
	}
	...
	public void unsetSeed() {
		...
		seedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.SCENARIO_PARAMETERS__SEED, oldSeed, SEED_EDEFAULT, oldSeedESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.SCENARIO_PARAMETERS__START:
				return basicSetStart(null, msgs);
			case ModelPackage.SCENARIO_PARAMETERS__DURATION:
				return basicSetDuration(null, msgs);
			case ModelPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SCENARIO_PARAMETERS__BASE_CURRENCY_UNIT:
				return getBaseCurrencyUnit();
			case ModelPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT:
				return getBaseTimeUnit();
			case ModelPackage.SCENARIO_PARAMETERS__REPLICATION:
				return getReplication();
			case ModelPackage.SCENARIO_PARAMETERS__SEED:
				return getSeed();
		}
