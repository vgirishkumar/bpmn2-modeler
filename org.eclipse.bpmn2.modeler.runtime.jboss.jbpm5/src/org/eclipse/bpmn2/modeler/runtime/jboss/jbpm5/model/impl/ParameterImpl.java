 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ParameterImpl#getResultRequest <em>Result Request</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ParameterImpl#getParameterValueGroup <em>Parameter Value Group</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ParameterImpl#getParameterValue <em>Parameter Value</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ParameterImpl#isKpi <em>Kpi</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.ParameterImpl#isSla <em>Sla</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends EObjectImpl implements Parameter {
	...
	public EList<ResultType> getResultRequest() {
		if (resultRequest == null) {
			resultRequest = new EDataTypeEList<ResultType>(ResultType.class, this, ModelPackage.PARAMETER__RESULT_REQUEST);
		}
	...
	public FeatureMap getParameterValueGroup() {
		if (parameterValueGroup == null) {
			parameterValueGroup = new BasicFeatureMap(this, ModelPackage.PARAMETER__PARAMETER_VALUE_GROUP);
		}
	...
	public EList<ParameterValue> getParameterValue() {
		return getParameterValueGroup().list(ModelPackage.Literals.PARAMETER__PARAMETER_VALUE);
	}
	...
	public void setKpi(boolean newKpi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAMETER__KPI, oldKpi, kpi, !oldKpiESet));
	}
	...
	public void unsetKpi() {
		...
		kpiESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.PARAMETER__KPI, oldKpi, KPI_EDEFAULT, oldKpiESet));
	}
	...
	public void setSla(boolean newSla) {
		...
		slaESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAMETER__SLA, oldSla, sla, !oldSlaESet));
	}
	...
	public void unsetSla() {
		...
		slaESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.PARAMETER__SLA, oldSla, SLA_EDEFAULT, oldSlaESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.PARAMETER__PARAMETER_VALUE_GROUP:
				return ((InternalEList<?>)getParameterValueGroup()).basicRemove(otherEnd, msgs);
			case ModelPackage.PARAMETER__PARAMETER_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PARAMETER__RESULT_REQUEST:
			...
			case ModelPackage.PARAMETER__KPI:
				return isKpi();
			case ModelPackage.PARAMETER__SLA:
				return isSla();
		}
