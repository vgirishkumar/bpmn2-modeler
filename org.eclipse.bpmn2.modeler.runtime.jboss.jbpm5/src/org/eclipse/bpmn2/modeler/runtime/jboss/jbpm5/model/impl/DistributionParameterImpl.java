 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.jboss.jbpm5.model.impl.DistributionParameterImpl#isDiscrete <em>Discrete</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DistributionParameterImpl extends ParameterValueImpl implements DistributionParameter {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.DISTRIBUTION_PARAMETER;
	}
	...
	public void setDiscrete(boolean newDiscrete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DISTRIBUTION_PARAMETER__DISCRETE, oldDiscrete, discrete, !oldDiscreteESet));
	}
	...
	public void unsetDiscrete() {
		...
		discreteESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.DISTRIBUTION_PARAMETER__DISCRETE, oldDiscrete, DISCRETE_EDEFAULT, oldDiscreteESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.DISTRIBUTION_PARAMETER__DISCRETE:
				return isDiscrete();
		}
