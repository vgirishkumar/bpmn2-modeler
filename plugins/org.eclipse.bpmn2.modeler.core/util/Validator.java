...
import org.eclipse.bpmn2.Bpmn2ElementName;
 ...
 *
 */
public class Bpmn2ElementNameValidator extends AbstractBpmn2ElementValidator<Bpmn2ElementName> {
	 ...
	 * @param ctx
	 */
	public Bpmn2ElementNameValidator(IValidationContext ctx) {
		super(ctx);
	}
	...
	public Bpmn2ElementNameValidator(AbstractBpmn2ElementValidator parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public IStatus validate(Bpmn2ElementName object) {
		return getResult();
	}
