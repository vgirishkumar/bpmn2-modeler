...
public class UpdateItemAwareElementFeature<T extends ItemAwareElement> extends AbstractBpmn2UpdateFeature {
	...
	public boolean update(IUpdateContext context) {
		...
		if (isCollection!=null) {
			...
			peService.setPropertyValue(container, Properties.COLLECTION_PROPERTY, Boolean.toString(newIsCollection));
		}
		
		// Update the Data State
		String newDataState = getDataStateAsString(element);
		peService.setPropertyValue(container, Properties.DATASTATE_PROPERTY, newDataState);
