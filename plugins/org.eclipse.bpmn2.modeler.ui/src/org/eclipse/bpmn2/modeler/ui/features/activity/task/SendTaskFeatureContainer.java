...
import org.eclipse.bpmn2.modeler.ui.features.activity.task.ScriptTaskFeatureContainer.AddScriptTaskFeature;
...
public class SendTaskFeatureContainer extends AbstractTaskFeatureContainer {
	...
	public IAddFeature getAddFeature(IFeatureProvider fp) {
		...
		multiAdd.addFeature(new AddSendTaskFeature(fp));
